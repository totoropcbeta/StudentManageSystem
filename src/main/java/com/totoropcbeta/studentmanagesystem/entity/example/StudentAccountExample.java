...
public class StudentAccountExample {
    ...
    public StudentAccountExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public StudentAccountExample orderBy(String... orderByClauses) {
    ...
    public StudentAccountExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public StudentAccountExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public StudentAccountExample distinct(boolean distinct) {
    ...
    public interface IExampleWhen {
        void example(com.totoropcbeta.studentmanagesystem.entity.example.StudentAccountExample example);
    }
    ...
    public static class Criteria extends GeneratedCriteria {
        private StudentAccountExample example;

        protected Criteria(StudentAccountExample example) {
            super();
            this.example = example;
        }

        public StudentAccountExample example() {
            return this.example;
        }
