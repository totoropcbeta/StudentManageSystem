...
public class PermissionInfoExample {
    ...
    public PermissionInfoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public PermissionInfoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public PermissionInfoExample distinct(boolean distinct) {
    ...
    public interface IExampleWhen {
        void example(com.totoropcbeta.studentmanagesystem.entity.example.PermissionInfoExample example);
    }
